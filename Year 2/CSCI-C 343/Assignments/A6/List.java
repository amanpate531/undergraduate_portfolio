...
abstract class List<E> {
    ...
    List<E> push (E elem) { return new NodeL<>(elem, this); }
...
class NodeL<E> extends List<E> {
    ...
    List<E> add (E elem) { return new NodeL<>(data, rest.add(elem)); }
